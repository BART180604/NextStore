...
const data:Props[]=[
...

    {
        ...
        icon:(<CalendarClock className="text-gray-600 group-hover:text-darkColor transition-colors " />)
    },
    {
        title:"Email Us",
        subtitle:"mbatamoussi81@gmail.com",
    ...
    return(
     <div className='flex items-center gap-3 group hover:bg-gray-50 p-4 transition-colors'>
        ...
        <div >
            ...
            <p className='text-gray-600 text-sm mt-1 transition-colors group-hover:text-gray-900'>{subtitle}</p>
        </div>
     </div>
    )
}
